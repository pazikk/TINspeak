...
void AudioEncoderOpus::EndInit()
{
    ...
    {
        printf("Audio encoded interface usually must be set.\n");
...
EncodedAudio AudioEncoderOpus::EncodeReturn(AudioFrame &frame)
{
    EncodedAudio invalidEncodedAudio;
    invalidEncodedAudio.isValid = false;
    invalidEncodedAudio.Data = nullptr;
